...
const activeRoute = "contact-page-contents";
const prismaTable = "contactPageContent";
const currentView = "contactPageContents";
const listPageTitle = "Contact page content";
